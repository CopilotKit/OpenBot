...
/*
 * REGISTERED ONCE, AND NEVER TORN DOWN. bun runs every test file in one process and the DOM is
 * global to it: a second unconditional `register()` throws, and an `unregister()` here empties the
 * document for every file scheduled afterwards. Alone this file was fine; beside the twenty-odd
 * other DOM tests in this suite it failed whichever ones happened to run after it. Every other file
 * here already registers behind this guard.
 */
beforeAll(() => {
